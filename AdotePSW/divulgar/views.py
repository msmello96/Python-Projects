...
def nova_raca(request):
    if request.method == "GET":
        return render(request, 'nova_raca.html')
    if request.method == "POST":
        nova_raca = request.POST.get('nova_raca')
        ...
        messages.add_message(request, constants.SUCCESS, "Nova raça adicionada com sucesso.")
        return render(request, 'nova_raca.html')
